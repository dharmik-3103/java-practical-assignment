...
class pr11 {
    public static void main(String[] args) throws ExecutionException {
        Triplet<String, Integer, Character> p1 = Triplet.of("Dharmik", 21, 'M');
        Triplet<String, Integer, Character> p2 = Triplet.of("Darshan", 19, 'M');
        Triplet<String, Integer, Character> p3 = Triplet.of("Harsh", 128, 'M');
